const data = [
    { name: "Anuj Das", age: 26, profession: "developer" },
    { name: "Monjur Elahi", age: 27, profession: "admin" },
  ];
  ...
  // 9. Update Profession
  function updateAnujsProfession() {
    const anuj = data.find((person) => person.name === "anuj");
    if (anuj) {
      anuj.profession = "manager";
      console.log("Updated Anuj's profession:", anuj);
    } else {
      console.log("Anuj is not found in the array.");
    }
  }
